    ...
    function uploadByType( tipo, id, nombreArchivo, res ) {
        if ( tipo === 'users') {
            Usuario.findById(id, (err, user) => {
                ...
                var pathViejo = '../server/uploadsusers/' + user.usr_img;
        ...
        if ( tipo === 'clients') {
            Cliente.findById(id, (err, client) => {
                ...
                var pathViejo = '../server/uploadsclients/' + client.client_logo;
        ...
        if ( tipo === 'categories') {
            Categoria.findById(id, (err, category) => {
                ...
                var pathViejo = '../server/uploadscategories/' + category.cat_img;
        ...
        if ( tipo === 'subcategories') {
            Subcategoria.findById(id, (err, subcategory) => {
                ...
                var pathViejo = '../server/uploadssubcategories/' + subcategory.subcat_img;
        ...
        if ( tipo === 'products') {
            Productos.findById(id, (err, product) => {
                ...
                var pathViejo = '../server/uploadsproducts/' + product.prod_img;
